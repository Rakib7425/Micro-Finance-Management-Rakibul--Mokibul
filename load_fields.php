...
$loan = $conn->query("SELECT l.*,concat(b.firstname,', ',b.middlename,' ',b.lastname)as name, b.contact_no, b.address from loan_list l inner join borrowers b on b.id = l.borrower_id where l.id = ".$_POST['loan_id']);

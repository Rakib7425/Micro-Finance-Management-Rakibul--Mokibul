...
<div class="container-fluid">
	...
	<div class="row">
		<div class="col-lg-12">
			<button class="btn btn-primary float-right btn-sm" id="new_user"><i class="fa fa-plus"></i> New Staff user</button>
		</div>
	</div>
	<br>
	<div class="row">
...
<script>
	...
	$('.delete_user').click(function() {
		_conf("Are you sure to terminate this user from your Data Base ?", "delete_user", [$(this).attr('data-id')])
	})
